...
var speed_background:float = 150 #velocidade do paralax dando efeito de velocidade da carta
...
var dificuldade:float = 4 + dia #valor provisorio pegar do papers please
