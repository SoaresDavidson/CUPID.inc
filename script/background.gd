...
func _process(delta):
	...
	nuvens.motion_offset.x -=  (GlobalVars.speed_background/2) * dificuldade * delta * GlobalVars.playing
	predios_longe.motion_offset.x -= (GlobalVars.speed_background/4) * dificuldade * delta * GlobalVars.playing
	predios_perto.motion_offset.x -= GlobalVars.speed_background * dificuldade * delta * GlobalVars.playing
